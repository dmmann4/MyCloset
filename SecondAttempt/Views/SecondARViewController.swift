//
//  SecondARViewController.swift
//  SecondAttempt
//
//  Created by David Mann on 7/5/19.
...
class SecondARViewController: UIViewController, ARSCNViewDelegate {
    ...
    @IBOutlet var finalView: ARSCNView!
    ...
    private func addPlane(hitTestResult: ARHitTestResult) {
        let scene = SCNScene(named: "art.scnassets/model/take2blend.scn")!
        let planeNode = scene.rootNode.childNode(withName: "jacketModel", recursively: true)
        ...
        planeNode?.scale = .init(0.5, 0.5, 0.5)
